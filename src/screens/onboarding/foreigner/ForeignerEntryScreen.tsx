...
type Props = NativeStackScreenProps<OnboardingStackParamList, "ForeignerEntry">;

export function ForeignerEntryScreen({ navigation }: Props) {
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.content}>
        <View style={styles.iconWrap}>
          <Ionicons name="airplane-outline" size={36} color={colors.surface} />
        </View>
        <Text style={styles.title}>{t("foreignerEntry.title")}</Text>
        <Text style={styles.subtitle}>{t("foreignerEntry.subtitle")}</Text>

        <TouchableOpacity style={styles.primaryButton} onPress={() => navigation.navigate("ForeignerLogin")}>
          <Text style={styles.primaryButtonText}>{t("foreignerEntry.login")}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate("ForeignerRegister")}>
          <Text style={styles.secondaryButtonText}>{t("foreignerEntry.register")}</Text>
        </TouchableOpacity>
